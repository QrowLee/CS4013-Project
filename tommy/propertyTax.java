...
public class propertyTax
{
    ...
    double penalty = .07;
    public Payment2 getTax(int missedYears, double estMarketVal, String location, boolean privateResidence, LocalDate date)
    {
        ...
        date = date.minusYears(missedYears);
        return new Payment2(tax*(penalty*missedYears),date);
    }
